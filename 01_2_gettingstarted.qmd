...
```bash
find /core/cbc/tutorials/workshopdirs/RNA-seq-with-reference-genome-and-annotation -name "*fastq.gz"
```
...
2. Create a directory named after your username here `/core/cbc/ISG5311/2024` (but use the current year if it is no longer 2024!) and move or copy this directory there. 
...
### Quiz: See Blackboard Ultra for this section's quiz. 
