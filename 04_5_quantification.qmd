...
A **functional annotation** contains functional information about genomic features. This can comprise any sort of knowledge, from tissues or life stages a gene is expressed in and its expression levels, to information about high level biological processes a feature may be involved with, to responses to environment. One common component of a functional annotation is the assignment of [Gene Ontology](https://geneontology.org) terms to genes. The Gene Ontology is a controlled vocabulary for describing gene products. We'll cover it in more detail later. A functional annotation often (though not always) refers back to elements in a structural annotation, but may not itself contain any structural or location information. 
