...
Log in to Mantis and check to see if either exist with `ls -a` to list all files (including hidden ones) in your home directory. If you don't have them, create them with:
